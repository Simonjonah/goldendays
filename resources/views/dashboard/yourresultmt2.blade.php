          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                ...
                <a href="{{ route('student.printresultmt2') }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                <a href="{{ route('student.printresultmt1and2') }}" target="_blank" class="btn btn-success"><i class="fas fa-print"></i> Check Your CGPA</a>
