            ...
            <div class="invoice p-3 mb-3">
                  ...
                  <table class="table table-striped">
                    ...
                    @foreach ($getyour_results as $getyour_result)
                        ...
                        <tr>
                            ...
                            <td>{{ $getyour_result->semester }} <small>{{ $getyour_result->level }}</small></td>
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  {{-- <a href="{{ route('student.printresultd1') }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a> --}}
                {{-- <a href="{{ route('student.printresultnid1sem') }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a> --}}
                {{-- <a href="{{ route('student.printresultnid2') }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Track 1st and 2nd Semester</a> --}}
                {{-- <a href="{{ route('student.printresultmt1and2and3') }}" target="_blank" class="btn btn-success"><i class="fas fa-print"></i> Check Your CGPA</a> --}}
