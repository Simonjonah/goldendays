                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select name="course_title1" class="form-control">
                          ...
                          <option value="Structured Query Language 2">Structured Query Language 2</option>
                          <option value="Relational Database Management System 2">Relational Database Management System 2</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="course_code1" class="form-control">
                          ...
                          <option value="CSE 225">CSE 225</option>
                          <option value="CSE 226">CSE 226</option>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="course_code5" class="form-control">
                            <option value="NIDSOFT2NDSEMLEV200">NID</option>
