        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.addnidsoft2ndsem') }}" class="btn btn-success">Add Semester Courses</a></li>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select name="course_title1" class="form-control">
                          ...
                          <option value="Basic Digital System">Basic Digital System</option>
                          <option value="File organization and management">File organization and management</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="course_code1" class="form-control">
                          ...
                          <option value="STA 111">STA 111</option>
