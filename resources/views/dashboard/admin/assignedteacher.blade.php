      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ url('admin/assignteachertoclass/'.$assign_teachers->ref_no) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              ...
              <div class="form-group">
                ...
                <select name="classname" class="form-control"  id="">
                  @foreach ($view_teachers as $view_teacher)
                    <option value="{{ $view_teacher->classname }}">{{ $view_teacher->fname }}  {{ $view_teacher->surname }} {{ $view_teacher->centername }}</option>
                  @endforeach
