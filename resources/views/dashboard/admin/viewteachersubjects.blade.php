                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($display_teachersubjects as $display_teachersubject)
                      ...
                      <tr>
                        <td><a href="{{ url('admin/viewsingleteacher/'.$display_teachersubject->user['ref_no']) }}" target="_blank" rel="noopener noreferrer">{{ $display_teachersubject->user['surname'] }}</a></td>
