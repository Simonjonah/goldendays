                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select name="course_title1" class="form-control">
                          <option value="Basic Electrity">Basic Electrity</option>
                          <option value="Operating Systems">Operating Systems</option>
                          <option value="Computer Workshop Practices 1">Computer Workshop Practices 1</option>
                          <option value="Basic Electronics">Basic Electronic</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="course_code1" class="form-control">
                          <option value="CHE 111">CHE 111</option>
                          <option value="CHE 112">CHE 112</option>
                          <option value="CHE 113">CHE 113</option>
                          <option value="CHE 114">CHE 114</option>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="course_code5" class="form-control">
                            <option value="NIDHARDFIRSTSEMLEVEL100L">NID</option>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <select name="course_title1" class="form-control">
                      ...
                      <option value="Enterprise Leadership & Character Development">Enterprise Leadership & Character Development</option>
                    </select>
                  </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>Course Code</label>
                    <select name="course_code1" class="form-control">
                      <option value="CHE 121">CHE 121</option>
                      <option value="CHE 122">CHE 122</option>
                      <option value="CHE 123">CHE 123</option>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Code</label>
                      <select name="course_code5" class="form-control">
                        <option value="NIDHARDSECONDSEM100L">NID</option>
