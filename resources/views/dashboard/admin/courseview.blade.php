                ...
                <div class="col-lg-6">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      @enderror value="{{ $view_courses->firstsemester_fee }}" id="exampleInputEmail1" placeholder="Course title">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      @enderror value="{{ $view_courses->secondsemester_fee }}" id="exampleInputEmail1" placeholder="Course title">
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  ...
                  {{-- <div class="card-body pad"> --}}
                   ...
                   <div class="form-group">
                    ...
                    @enderror value="{{ $view_courses->thirddsemester_fee }}" id="exampleInputEmail1" placeholder="Course title">
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Category</label>
                      ...
                      <select class="form-control" name="category">
                        <option value="{{ $view_courses->category }}">{{ $view_courses->category }}</option>
