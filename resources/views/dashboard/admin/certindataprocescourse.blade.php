                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="programname_id" class="form-control">
                          @foreach ($display_programs as $display_program)
                            @if ($display_program->status == 'approved')
                              <option value="{{ $display_program->id }}">{{ $display_program->course_programs }} {{ $display_program->lname }}</option>
                            @else
                            @endif
                          @endforeach
