                  ...
                  <tbody>
                    ...
                    @foreach ($viewall_payments as $viewall_payment)
                      ...
                      <tr>
                        ...
                        <td>{{ $viewall_payment->regnumber }}</td>
                        
                        <td>{{ $viewall_payment->programname }}</td>
                         
                         <td><a href="{{ url('admin/viewsfees/'.$viewall_payment->ref_no) }}"
                          class='btn btn-info'>
                      ...
                      <td><a href="{{ url('admin/deletepaymentfirst/'.$viewall_payment->slug) }}"
