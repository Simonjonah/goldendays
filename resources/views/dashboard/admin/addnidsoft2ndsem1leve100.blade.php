        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#" class="btn btn-success">Add Semester Courses</a></li>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select name="course_title1" class="form-control">
                          <option value="Network Design Topology & Network Protocol">Network Design Topology & Network</option>
                          <option value="Network Caling">Network Caling</option>
                          <option value="Configuration of Network Devices">Configuration of Network Devices</option>
                          <option value="Introduction to Digital Communication Networks">Introduction to Digital Communication Networks</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="course_code1" class="form-control">
                          <option value="NSS 121">NSS 121</option>
                          <option value="NSS 122">NSS 122</option>
                          <option value="NSS 123">NSS 123</option>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="course_code5" class="form-control">
                            <option value="NIDNET2NDSEMLEV100">NID</option>
                          </select>
                        </div>
                      </div>
