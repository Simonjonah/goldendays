      ...
      <div class="col-12 table-responsive">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            @if ($printyour_course->registercourse['course_code5'] == 'NID' && $printyour_course->registercourse['semester'] == 'Second Semester' && $printyour_course->student['programname'] == 'NID Computer Software Engineering Technology')
            <tr>
