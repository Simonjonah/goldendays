            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                <form action="{{ route('student.registeryourcouse') }}" method="post" enctype="multipart/form-data">
                  ...
                  @foreach ($disall_subjects as $disall_subject)
                    @if ($disall_subject->programname == 'Diploma in Data Processing')
                          ...
                          <div class="form-group">
                            <div class="input-group">
                              <div class="input-group-prepend">
                               ...
                               <label for="">{{ $disall_subject->course_programs }}</label>
                               <label for="">{{ $disall_subject->programname }}</label>
