          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
                  ...
                  <table class="table table-striped">
                    ...
                    @foreach ($getyour_results as $getyour_result)
                        ...
                        <tr>
                            ...
                            <td>{{ $getyour_result->semester }} {{ $getyour_result->level }}</td>
              ...
              <div class="row no-print">
                ...
                {{-- <a href="{{ route('student.printresultnid1sem2') }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a> --}}
                <a href="{{ route('student.printresultnid2') }}" target="_blank" class="btn btn-success"><i class="fas fa-print"></i> Check Your CGPA</a>
